...
locationBtn.addEventListener('click', function(event) {
  ...
  navigator.geolocation.getCurrentPosition(function(position) {
    ...
    locationInput.value = 'In brooklyn';
...
// Currently not in use, allows to save assests in cache on demand otherwise 
...
var url = 'https://pwagram-1c0ae.firebaseio.com/posts.json';
